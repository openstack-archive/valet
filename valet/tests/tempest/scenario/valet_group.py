...
class ValetGroup(object):
    """Class to represent valet group for tempest tests."""

    def __init__(self):
        """Init valet group with url and headers."""
    ...
    def create_group(self, group_name, group_type):
        """Create valet group with name and type."""
    ...
    def get_group_details(self, group_id):
        """Get url for group with id and return headers (details)."""
        url = self.groups_url + "/" + group_id
        return requests.get(url, headers=self.headers)

    def update_group_members(self, group_id, members=None):
        """Update group members from group with id."""
    ...
    def delete_all_groups(self):
        """Delete all groups, return 204 if successful."""
        DELETED = 204
