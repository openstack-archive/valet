...
class TestStackUpdatesNonValet(ScenarioTestCase):
    ...
    def test_updates_no_groups_upd_desc(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_no_groups_upd_desc",
    ...
    def test_updates_no_groups_upd_flavor(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_no_groups_upd_flavor",
                                                 "/templates/no_groups_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_no_groups_add_server(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_no_groups_add_server",
                                                 "/templates/no_groups_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_no_groups_remove_server(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_no_groups_remove_server",
                                                 "/templates/no_groups_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_nova_group_remove_server(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nova_group_remove_server",
    ...
    def test_updates_nova_group_add_server(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nova_group_add_server",
                                                 "/templates/nova_group_1_instance.yml")
        self.update_stack(stack_id, stack_name,
                          "/templates/nova_group_2_instances.yml")
    ...
    def test_updates_nova_group_upd_flavor(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nova_group_upd_flavor",
                                                 "/templates/nova_group_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_nova_group_add_group(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nova_group_add_group",
                                                 "/templates/nova_group_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_nova_group_remove_group(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nova_group_remove_group",
                                                 "/templates/nova_group_2_instances_2_groups.yml")
        self.update_stack(stack_id, stack_name,
                          "/templates/nova_group_2_instances.yml")
    ...
    def test_updates_nova_group_upd_group_policy(self):
        # Change the group policy of a Nova Server group (affinity -> anti-affinity)
        stack_id, stack_name = self.create_stack("test_updates_nova_group_upd_group_policy",
                                                 "/templates/nova_group_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_nova_group_move_server(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nova_group_move_server",
                                                 "/templates/nova_group_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_nova_group_remove_group_assignment(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nova_group_remove_group_assignment",
                                                 "/templates/nova_group_2_instances.yml")
        self.update_stack(stack_id, stack_name,
                          "/templates/no_groups_2_instances.yml")
    ...
    def test_updates_multiple_resources_upd_security_rule(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_multiple_resources_upd_security_rule",
    ...
    def test_updates_multiple_resources_remove_network(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_multiple_resources_remove_network",
                                                 "/templates/multiple_resource_types.yml")
        self.update_stack(stack_id, stack_name,
                          "/templates/multiple_resource_types_remove_network.yml")
    ...
    def test_updates_nested_upd_desc(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nested_upd_desc",
    ...
    def test_updates_nested_upd_flavor(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nested_upd_flavor",
                                                 "/templates/nested_total_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_nested_add_server(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nested_add_server",
                                                 "/templates/nested_total_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_nested_remove_server(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nested_remove_server",
                                                 "/templates/nested_total_3_instances.yml")
        self.update_stack(stack_id, stack_name,
                          "/templates/nested_total_2_instances.yml")
    ...
    def test_updates_nested_increase_inner_instance_count(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nested_increase_inner_instance_count",
                                                 "/templates/nested_total_2_instances.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_nested_decrease_inner_instance_count(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nested_decrease_inner_instance_count",
                                                 "/templates/nested_total_3_instances_count_increase.yml")
        self.update_stack(stack_id, stack_name,
                          "/templates/nested_total_2_instances.yml")
    ...
    def test_updates_nested_nova_group_upd_flavor(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nested_nova_group_upd_flavor",
                                                 "/templates/nested_total_2_instances_nova_group.yml")
        self.update_stack(stack_id, stack_name,
                          "/templates/nested_total_2_instances_nova_group_upd_flavor.yml")
    ...
    def test_updates_nested_nova_group_add_server(self):
        ...
        stack_id, stack_name = self.create_stack("test_updates_nested_nova_group_add_server",
                                                 "/templates/nested_total_2_instances_nova_group.yml")
        self.update_stack(stack_id, stack_name,
    ...
    def test_updates_nested_nova_group_remove_server(self):
        # Remove one of the nova servers from the group inside the inner template
        stack_id, stack_name = self.create_stack("test_updates_nested_nova_group_remove_server",
                                                 "/templates/nested_total_3_instances_nova_group.yml")
        self.update_stack(stack_id, stack_name,
                          "/templates/nested_total_2_instances_nova_group.yml")
