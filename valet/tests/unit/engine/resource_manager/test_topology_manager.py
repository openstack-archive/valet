...
class TestTopologyManger(Base):
    ...
    # TODO(JC): test run and _run methods
    ...
    def test_set_topology_status_success_update_true(self, mock_set_topology,
        ...
        result = self.manager.set_topology()
        self.manager.resource.update_topology.\
            assert_called_once_with(store=False)
    ...
    def test_set_topology_status_success_update_false(self, mock_set_topology,
        ...
        result = self.manager.set_topology()
        self.manager.resource.update_topology.assert_not_called()
        self.assertTrue(result)

    # TODO(JC): test _check_update method
    ...
    # TODO(JC): test _check_host_group_update and _check_datacenter_update
