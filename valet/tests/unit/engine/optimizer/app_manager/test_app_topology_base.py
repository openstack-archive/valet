...
class TestAppTopologyBase(Base):
    ...
    def test_get_json_info_vgroup(self):
        ...
        self.vgroup.availability_zone_list = self.availability_zones
        ...
        self.assertEqual(self.vgroup_test_info, result)
    ...
    def test_get_json_info_vm(self):
        ...
        self.vm.availability_zone = self.availability_zones
        ...
        self.assertEqual(self.vm_test_info, result)
