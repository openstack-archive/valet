...
class TestOstroHelper(api_base.ApiBase):
    ...
    def test_build_request_host_affinity_using_metadata(
        self, mock_results):
    ...
    @mock.patch.object(models.Results, 'first')
    def test_build_request_host_diversity_using_metadata(
        self, mock_results):
    ...
    @mock.patch.object(models.Results, 'first')
    def test_build_request_host_exclusivity_using_metadata(
        self, mock_results):
    ...
    @mock.patch.object(models, 'PlacementRequest')
