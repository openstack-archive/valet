...
import valet.db.models.event as event
import valet.db.models.group as group
import valet.db.models.placement as placement
import valet.db.models.placement_requests as placement_requests
import valet.db.models.placement_result as placement_result
import valet.db.models.plan as plan
...
def init_db():
    assert [event, group, placement, placement_requests, placement_result, plan]
